...
public final class SimpleHttpConnector implements HttpConnector {
     ...
     */
    public static int DEFAULT_BUFFER_SIZE = Integer.getInteger(
            "shc.buffer_size", 4096).intValue();
    /**
     * The default connect timeout (10000 or the system property
     * "shc.connect_timeout")
     */
    public static int DEFAULT_CONNECT_TIMEOUT = Integer.getInteger(
            "shc.connect_timeout", 10000).intValue();
    /**
     * The defualt follow redirect flag (false or the system property
     * "shc.follow_redirects")
     */
    public static boolean DEFAULT_FOLLOW_REDIRECT = !"false".equals(System
            .getProperty("shc.follow_redirects"));
    ...
    public SimpleHttpConnector() {
        this(DEFAULT_BUFFER_SIZE, DEFAULT_CONNECT_TIMEOUT,
                DEFAULT_FOLLOW_REDIRECT);
    }

    public SimpleHttpConnector(int bufferSize, int connectTimeout,
    ...
    static HttpURLConnection getConnection(String url, Map<?, ?> headers)
            throws IOException {
        try {
            ...
            Log.debug("let's continue");
        }
        return (HttpURLConnection) new URL(url).openConnection();
    }

    static HttpURLConnection getConnection(String url,
            Iterable<Parameter> headers) throws IOException {
        try {
            HttpURLConnection connection = (HttpURLConnection) new URL(url)
                    .openConnection();
            if (headers != null) {
    ...
    static String appendUrl(String url, Map<?, ?> queryParams) {
        ...
        for (Map.Entry<?, ?> entry : queryParams.entrySet()) {
            buffer.append(separator)
                    ...
                    .append('=')
                    .append(UrlEncoded
                            .encodeString(entry.getValue().toString()));
            separator = '&';
        }
    ...
    static String appendUrl(String url, Iterable<Parameter> queryParams) {
        ...
        for (Parameter p : queryParams) {
            buffer.append(separator).append(p.getKey()).append('=')
                    .append(UrlEncoded.encodeString(p.getValue()));
            separator = '&';
        }
        return buffer.toString();
    }
    ...
    static byte[] getEncodedData(Iterable<Parameter> parameters, String charset)
        ...
        for (Parameter p : parameters) {
            buffer.append('&').append(p.getKey()).append('=')
                    .append(UrlEncoded.encodeString(p.getValue().toString()));
        }
        return buffer.substring(1).getBytes(charset);
    }
    ...
    public Response doHEAD(String url, Iterable<Parameter> headers)
            throws IOException {
        return send(HEAD, getConnection(url, headers));
    }
    ...
    public Response doPOST(String url, Map<?, ?> headers, Map<?, ?> parameters,
    ...
    public Response doPOST(String url, Map<?, ?> headers,
            Iterable<Parameter> parameters, String charset) throws IOException {
        if (parameters == null)
            return send(POST, getConnection(url, headers));
    ...
    public Response doPOST(String url, Iterable<Parameter> headers,
            Map<?, ?> parameters, String charset) throws IOException {
        if (parameters == null)
            return send(POST, getConnection(url, headers));
    ...
    public Response doPOST(String url, Map<?, ?> headers, String contentType,
        ...
        return sendContent(POST, getConnection(url, headers), contentType,
                reader);
    }

    public Response doPOST(String url, Iterable<Parameter> headers,
            String contentType, InputStreamReader reader) throws IOException {
        return sendContent(POST, getConnection(url, headers), contentType,
                reader);
    }
    ...
    public Response doPUT(String url, Map<?, ?> headers, Map<?, ?> parameters,
            String charset) throws IOException {
        if (parameters == null)
    ...
    public Response doPUT(String url, Map<?, ?> headers,
            Iterable<Parameter> parameters, String charset) throws IOException {
        if (parameters == null)
            return send(PUT, getConnection(url, headers));
    ...
    public Response doPUT(String url, Iterable<Parameter> headers,
            Map<?, ?> parameters, String charset) throws IOException {
        if (parameters == null)
            return send(PUT, getConnection(url, headers));
    ...
    public Response doPUT(String url, Map<?, ?> headers, String contentType,
            InputStreamReader reader) throws IOException {
        return sendContent(PUT, getConnection(url, headers), contentType,
                reader);
    }
    ...
    Response sendContent(String method, HttpURLConnection connection,
        ...
        connection.setRequestProperty(CONTENT_LENGTH_HEADER,
