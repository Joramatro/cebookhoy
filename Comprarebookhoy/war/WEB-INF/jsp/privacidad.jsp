    	...
    	<div class="container" style=" padding-bottom: 100px; ">
	    	...
	    	<div class="row">
				...
				<div class="span8">
					...
					<!-- start: About Us -->
					<div id="about">
						<div class="title"><h3>Política de Privacidad</h3></div>
...
<p><a href="http://www.google.com/intl/es_ALL/privacypolicy.html">Google Adsense</a><br />
...
<p>Si tiene preguntas o cuestiones sobre esta Política, no dude en contactarse en cualquier momento a través del formulario de contacto disponible en el sitio o por medio de la sección <a href="/contacto">contacto</a>.</p>
					</div>
				</div>
			</div>
